...
- [`box64-callback-track/`](box64-callback-track/) measures Box64 callback address-origin recognition with a native callback passed through a guest-visible bridge.
